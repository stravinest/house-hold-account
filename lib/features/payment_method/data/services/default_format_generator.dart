...
class DefaultFormatGenerator {
  ...
  static const Map<String, _FinancialServiceInfo> _financialServices = {
    ...
    '롯데': _FinancialServiceInfo(
      smsKeywords: ['롯데카드', '롯데'],
      pushKeywords: ['롯데카드', '롯데'],
      pushPackage: 'com.lotte.lottesmartpay',
    ...
    'NH': _FinancialServiceInfo(
      smsKeywords: ['NH카드', 'NH', '농협카드'],
      pushKeywords: ['NH카드', 'NH', '농협카드'],
      pushPackage: 'nh.smart.card',
      smsSenderPattern: 'NH',
    ),
    'BC': _FinancialServiceInfo(
      smsKeywords: ['BC카드', 'BC'],
      pushKeywords: ['BC카드', 'BC'],
      pushPackage: 'com.bccard.bcpaybooc',
      smsSenderPattern: 'BC카드',
    ),

    // 지역화폐
    '수원페이': _FinancialServiceInfo(
      smsKeywords: ['수원페이', '경기지역화폐', '수원이'],
      pushKeywords: ['수원페이', '경기지역화폐', '수원이'],
      pushPackage: 'com.thepayglobal.gyeonggipay',
      smsSenderPattern: '경기지역화폐',
    ),
    '경기지역화폐': _FinancialServiceInfo(
      smsKeywords: ['경기지역화폐', '수원페이', '수원이'],
      pushKeywords: ['경기지역화폐', '수원페이', '수원이'],
      pushPackage: 'com.thepayglobal.gyeonggipay',
      smsSenderPattern: '경기지역화폐',
    ),
